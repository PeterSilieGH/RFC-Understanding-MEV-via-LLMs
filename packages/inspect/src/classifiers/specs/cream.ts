// Ports mev_inspect/classifiers/specs/cream.py (Cream finance, Compound V2 fork).
...
const CRETH_TOKEN_ADDRESS = "0xd06527d5e56a3495252a528c4987003b712860ee";
const creamLiquidationClassifier = makeCompoundLiquidationClassifier(CRETH_TOKEN_ADDRESS);

export const CREAM_CLASSIFIER_SPECS: ClassifierSpec[] = [
  {
    abiName: "CEther",
    protocol: Protocol.cream,
    validContractAddresses: [CRETH_TOKEN_ADDRESS],
    classifiers: {
