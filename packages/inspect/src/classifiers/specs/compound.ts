// Ports mev_inspect/classifiers/specs/compound.py (Compound V2).
import { type ClassifierSpec, Protocol } from "../../types.js";
import { makeCompoundLiquidationClassifier, seizeClassifier } from "./compoundLike.js";

const CETH_TOKEN_ADDRESS = "0x4ddc2d193948926d02f9b1fe9e1daa0718270ed5";
const compoundLiquidationClassifier = makeCompoundLiquidationClassifier(CETH_TOKEN_ADDRESS);

export const COMPOUND_CLASSIFIER_SPECS: ClassifierSpec[] = [
  {
    abiName: "CEther",
    protocol: Protocol.compound_v2,
    validContractAddresses: [CETH_TOKEN_ADDRESS],
    classifiers: {
